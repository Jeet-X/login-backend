...
const QuizManagement: React.FC = () => {
    ...
    const handleEdit = (q: Question) => {
        setEditingId(q.id);
        const parentCat = categories.find(cat => cat.sub_categories.some(sub => sub.id === q.sub_category_id));
        if (parentCat) {
                                ...
                                <div className="card stat-card total">
                                    ...
                                    <div className="stat-sub">
                                        {filters.sub_category_id ?
                                            `In: ${allSubCategories.find(s => s.id === filters.sub_category_id)?.name}` :
                                    ...
                                    <div key={q.id} className="question-horizontal-card animate-fadeIn">
                                        ...
                                        <div className="card-footer-info">
                                            <div className="meta-info">
                                                ...
                                                <span>{allSubCategories.find(s => s.id === q.sub_category_id)?.name || 'General'}</span>
                                            </div>
                                            <div className="meta-info">
