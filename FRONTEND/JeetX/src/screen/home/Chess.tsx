                    ...
                    <ScrollView style={[styles.contentBody, styles.chessListLayout]}>
                        <View style={[styles.mathQuizParent, styles.body1Position]}>
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                ...
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Maths Quiz</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Sports Quiz</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Entertainment Quiz</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Music Quiz</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Political Knowledge Quiz</Text>
                        ...
                        <View style={[styles.body1, styles.body1Position]}>
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Cricket</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Football</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                ...
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Kabaddi</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Esports</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Stocks</Text>
                        ...
                        <View style={[styles.puzzleList, styles.body1Position]}>
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Logic Puzzle</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Number Puzzle</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Word Puzzle</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Picture Puzzle</Text>
                            ...
                            <View style={[styles.mathQuiz, styles.mathLayout]}>
                                <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                <Text style={[styles.mathsQuiz, styles.chess2FlexBox]}>Sequence Puzzle</Text>
                        ...
                        <ScrollView style={[styles.chessList, styles.chessListLayout]}>
                            <View style={styles.mathQuizGroup}>
                                <View style={[styles.mathQuiz, styles.mathLayout]}>
                                    <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                    <Text style={[styles.classicChess, styles.mathsQuiz2Typo]}>Classic Chess</Text>
                                ...
                                <View style={[styles.mathQuiz, styles.mathLayout]}>
                                    <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                    <Image style={styles.ellipseIcon} resizeMode="cover" />
                                    <Text style={[styles.classicChess, styles.mathsQuiz2Typo]}>Bullet Chess</Text>
                                ...
                                <View style={[styles.mathQuiz, styles.mathLayout]}>
                                    <View style={[styles.mathQuizChild, styles.categoriesBg]} />
                                    <Text style={[styles.classicChess, styles.mathsQuiz2Typo]}>Tournaments</Text>
                            ...
                            <Text style={[styles.byPinerootTechnologies, styles.frameGroupPosition]}>by Pineroot Technologies Private Limited</Text>
                        ...
                        <ScrollView style={[styles.frameParent, styles.leaderboardPosition]} horizontal={true} contentContainerStyle={styles.frameContainer25Content}>
                            <View style={styles.frameWrapper}>
                                <View style={[styles.appsUndefinedGlyphUndeParent, styles.parentFlexBox1]}>
                                    ...
                                    <Text style={[styles.quizzes, styles.chess2FlexBox]}>Quizzes</Text>
                                </View>
                            </View>
                            <Pressable style={styles.frameWrapper} onPress={() => { }}>
                                <View style={[styles.appsUndefinedGlyphUndeGroup, styles.parentFlexBox1]}>
                                    ...
                                    <Image style={[styles.appsUndefinedGlyphUnde, styles.undefinedLayout]} resizeMode="cover" />
                                    <Image style={[styles.appsUndefinedGlyphUnde, styles.undefinedLayout]} resizeMode="cover" />
                                    <Text style={[styles.quizzes, styles.chess2FlexBox]}>Ludo</Text>
                                </View>
                            </Pressable>
                            <Pressable style={styles.frameWrapper} onPress={() => { }}>
                                <View style={[styles.appsUndefinedGlyphUndeGroup, styles.parentFlexBox1]}>
                                    <Image style={[styles.appsUndefinedGlyphUnde, styles.undefinedLayout]} resizeMode="cover" />
                                    <Image style={[styles.appsUndefinedGlyphUnde, styles.undefinedLayout]} resizeMode="cover" />
                                    <Text style={[styles.quizzes, styles.chess2FlexBox]}>Puzzles</Text>
                                </View>
                            </Pressable>
                            <View style={styles.frameWrapper}>
                                <View style={[styles.appsUndefinedGlyphUndeGroup, styles.parentFlexBox1]}>
                                    ...
                                    <Image style={[styles.appsUndefinedGlyphUnde, styles.undefinedLayout]} resizeMode="cover" />
                                    <Image style={[styles.appsUndefinedGlyphUnde, styles.undefinedLayout]} resizeMode="cover" />
                                    <Text style={[styles.chess2, styles.text4Typo]}>Chess</Text>
                                </View>
                            </View>
                        </ScrollView>
